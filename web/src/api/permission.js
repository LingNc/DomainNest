...
export const revokeRequest = (nodeId, userId) => request.post(`/domains/${nodeId}/permissions/${userId}/revoke-request`)
export const acceptReturn = (nodeId, userId, data) => request.post(`/domains/${nodeId}/permissions/${userId}/accept-return`, data)
