...
export const getPermissions = (nodeId, config) => request.get(`/domains/${nodeId}/permissions`, config)
...
export const getPendingRecords = (nodeId, config) => request.get(`/domains/${nodeId}/pending-records`, config)
