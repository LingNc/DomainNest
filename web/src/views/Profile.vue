<template>
  <div class="profile-page">
    <el-tabs v-model="activeTab">
      <el-tab-pane :label="$t('profile.tabPersonal')" name="personal">
        <el-card>
          <template #header>
      ...
      <el-tab-pane :label="$t('profile.tabInvite')" name="invite">
        <el-card>
          <template #header>
            ...
            <el-table-column :label="$t('profile.direction')" min-width="180">
              <template #default="{ row }">
                <template v-if="row.inviter_id === profile.id">
                  ...
                  <span v-if="row.action === 'revoke'" style="margin:0 4px">&larr;</span>
                  <span v-else style="margin:0 4px">&rarr;</span>
